...
- **Χρόνος Εκπαίδευσης**: ~2 λεπτά (500k timesteps, ανάλογα με hardware)
...
Μετά την εκπαίδευση 500,000 timesteps (~2 λεπτά):
- **Success Rate**: **100%** (ο πράκτορας φτάνει τον στόχο σε κάθε επεισόδιο)
- **Mean Reward**: **-117.10 ± 2.59**
- **Mean Steps**: **~117 βήματα**
- **Στρατηγική**: Ο πράκτορας μαθαίνει να ταλαντώνεται μπρος-πίσω για δημιουργία ορμής
